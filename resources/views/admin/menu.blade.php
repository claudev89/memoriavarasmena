<div class="list-group">
    ...
    @role('admin')
        ...
        <a href="{{ route('admin.config') }}" class="list-group-item list-group-item-action {{ (request()->is('admin/config')) ? 'bg-secondary bg-opacity-25 negri' : '' }}"><i class="bi bi-gear"></i> Configuración de la página</a>
    @endrole
</div>
